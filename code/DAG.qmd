...
survival_dag = dagify(Survival ~ EMT_Score + Disease_Stage + Age + Immune_Infiltrate + Treatment + Sex + CAF_Infiltrate + Tumor_Gene_Profile,
                      EMT_Score ~ Disease_Stage +  Tissue_Rollup + Tumor_Gene_Profile,
                      Treatment ~ Disease_Stage + Sample_Collection_Year,
                      Immune_Infiltrate ~ Tissue_Rollup,
                      Tissue_Rollup ~ Disease_Stage,
                      Tumor_Gene_Profile ~ Disease_Stage + Immune_Infiltrate + CAF_Infiltrate + Tissue_Rollup,
