...
png(filename = "../outputs/plots/cell_types_in_WGCNA_modules.png", height = 400, width = 600, res = 120)
ggplot(enricher_results_df, aes(x = Cell_Type, y = ID)) +
  geom_tile(aes(fill = `p.adjust`)) +
  scale_fill_gradient(low = "red", high = "white") +
  labs(x = "Cell Signature", y = "WGCNA Module", fill = "Adjusted P-Value", title = "Enrichment of Cell Signatures in\nWGCNA Modules") + 
